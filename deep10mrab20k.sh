...
mkdir rabbit
cd rabbit
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../gen_syn_pts.py 10000000 50 15 150 5 2 4 30000 10000 20 > prb20_v100_deep10m_30k_rab.out
