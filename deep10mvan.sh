...
cd vanilla
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../gen_syn_pts.py 8000000 50 15 150 5 0 4 10000 1000 20 > prb20_v100_deep8m_10k_van.out
