...
cd ../../
mkdir deep10m30kMGPUnvvp
cd deep10m30kMGPUnvvp

mkdir rabbit
cd rabbit

export LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so
nvprof -o mGPU.prof python ../../gen_syn_pts.py 8000000 50 15 150 5 2 4 30 10000 20
