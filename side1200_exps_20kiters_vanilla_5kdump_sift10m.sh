...
#SBATCH --job-name sift10mvanilla      # you can give your job a name for easier identification (same as -J)
...
mkdir 1200bin
cd 1200bin
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../../gen_syn_pts.py 10000000 50 15 150 5 0 4 20000 50001 20 1200 2 1 5 > sift10m_20kiter_vanilla_side1200log.out
