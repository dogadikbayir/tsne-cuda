...
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../gen_syn_pts.py 2000000 50 15 150 3 0 4 20000 50001 20 200 2 1 5 > rabbit_2M_20kiter_side200vanillalog.out

cd ../../googlenews
mkdir vanilla
cd vanilla
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../gen_syn_pts.py 3000000 50 15 150 4 0 4 20000 50001 20 200 2 1 5 > gn_20kiter_side200vanilla_log.out
