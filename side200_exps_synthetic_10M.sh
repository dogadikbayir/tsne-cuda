...
#SBATCH --job-name synth10m      # you can give your job a name for easier identification (same as -J)
...
mkdir vanilla
cd vanilla
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../gen_syn_pts.py 10000000 50 15 150 2 0 10 20000 50001 20 800 2 1 5 > vanilla_10M_20kiter_synlog.out
