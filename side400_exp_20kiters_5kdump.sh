...
mkdir rabbit
cd rabbit
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../gen_syn_pts.py 2000000 50 15 150 3 2 4 20000 5000 20 400 2 1 5 > rabbit_2M_20kiter_side400log.out

cd ../../googlenews
mkdir rabbit
cd rabbit
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../gen_syn_pts.py 3000000 50 15 150 4 2 4 20000 5000 20 400 2 1 5 > gn_20kiter_side400log.out

cd ../../deep10m
mkdir rabbit
cd rabbit
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.sopython../../../gen_syn_pts.py 10000000 50 15 150 5 2 4 20000 5000 20 400 2 1 5 > deep10m_20kiter_side400log.out
