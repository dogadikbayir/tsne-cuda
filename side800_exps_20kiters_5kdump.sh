...
mkdir 800bin
cd 800bin
LD_PRELOAD=/mnt/home/dikbayir/bin_gperf/lib/libtcmalloc_minimal.so python ../../../../gen_syn_pts.py 3000000 50 15 150 4 2 4 20000 5000 20 800 2 1 5 > gn_20kiter_side800log.out
